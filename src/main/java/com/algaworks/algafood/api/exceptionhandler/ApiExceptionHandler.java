...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, 
		...
		return super.handleTypeMismatch(null, headers, status, request);
	}
	...
	// Tipo de tratativa que quero dar para a exception
	@Override
	...
	// Método do controlador que tratam exceções dentro do próprio controlador
